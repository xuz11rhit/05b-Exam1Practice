...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -1.969  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([40, 50], expected, test_results,
                                  format_string)
    actual = problem1a(40, 50)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
